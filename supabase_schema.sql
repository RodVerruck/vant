...
CREATE TABLE IF NOT EXISTS public.subscriptions (
    ...
    plan TEXT NOT NULL, -- ex: 'premium_plus'
    status TEXT NOT NULL, -- ex: 'active', 'canceled', 'incomplete'
    ...
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW(),
    UNIQUE (user_id, plan) -- apenas uma assinatura por plano por usuário (simplificado)
);
...
CREATE TABLE IF NOT EXISTS public.usage (
    ...
    limit INTEGER NOT NULL DEFAULT 30, -- limite mensal para premium_plus
    created_at TIMESTAMPTZ DEFAULT NOW(),
    updated_at TIMESTAMPTZ DEFAULT NOW(),
