      ...
      {isPerfectScore ? (
        ...
        <div className="vant-glass-dark vant-animate-fade" style={{ animationDelay: '0.3s' }}>
          <div style={{ textAlign: 'center' }}>
            ...
            {/* Preview Antes/Depois do CV */}
            {previewData.gap_1?.exemplo_atual && previewData.gap_1?.exemplo_otimizado && (
              <div style={{
                maxWidth: '700px',
                margin: '0 auto 2rem',
                ...
                <div style={{
                  ...
                  Preview: Como otimizamos seu CV
                </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    "{previewData.gap_1.exemplo_atual}"
                  </div>
                </div>
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    {previewData.gap_1.exemplo_otimizado.replace(/\*\*/g, '').replace(/\*/g, '')}
                  </div>
                </div>
