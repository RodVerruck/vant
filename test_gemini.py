#!/usr/bin/env python3
"""
Script para testar Gemini 1.5 Flash após migração do Groq
"""
import os
import sys
...
def test_gemini_models():
    ...
    print("🧪 Testando modelos Gemini 1.5 Flash...")
    ...
    try:
        print("🔍 Testando agent_diagnosis com Gemini 1.5 Flash...")
...
if __name__ == "__main__":
    ...
    if success:
        print("\n🎉 Teste com Gemini 1.5 Flash concluído com sucesso!")
        print("💰 Modelo mais econômico selecionado para evitar rate limits")
    else:
        print("\n💥 Teste falhou!")
        sys.exit(1)
